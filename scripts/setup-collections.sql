...
-- COLLECTION 1: "chats"
-- Collection ID: chats (exactly as written)
-- Attributes:
...
-- Collection ID: messages (exactly as written)
-- Attributes:
...
-- IMPORTANT: Make sure the Collection IDs are exactly "chats" and "messages" (lowercase, no spaces)
